...
// //  Trying out updating a single image inside the array of images and from cloudinary
...
//         name: name || product.name,
//         price: price || product.price,
//         images: product.images.slice(), // Create a copy of the original images array
//         public_id: product.public_id.slice(), // Create a copy of the original public_id array
//       };
  
//       const imageIndex = req.params.imageIndex; // Get the index of the image to update
//       if (req.files && req.files.images) {
//         const newImage = req.files.images;
//         const file = await cloudinary.uploader.upload(newImage.path, { folder: 'Class-Drill' });
        
//         // Delete the previous image from Cloudinary using the public ID at the specified index
//         await cloudinary.uploader.destroy(data.public_id[imageIndex]);
        
//         data.images[imageIndex] = file.secure_url;
//         data.public_id[imageIndex] = file.public_id;
//         await fs.unlinkSync(newImage.path)
//       }
